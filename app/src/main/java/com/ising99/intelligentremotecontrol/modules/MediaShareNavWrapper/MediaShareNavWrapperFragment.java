...
public class MediaShareNavWrapperFragment extends Fragment implements MediaShareNavWrapperContracts.View {

    private Presenter presenter;
    private ViewGroup view;

    public MediaShareNavWrapperFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = (ViewGroup) inflater.inflate(R.layout.fragment_media_share_nav_wraper, container, false);
        presenter.onCreate();
        return view;
    }
