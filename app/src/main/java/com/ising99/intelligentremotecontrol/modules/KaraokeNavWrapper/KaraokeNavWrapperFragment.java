...
public class KaraokeNavWrapperFragment extends Fragment implements KaraokeNavWrapperContracts.View {

    private Presenter presenter;
    private ViewGroup view;

    public KaraokeNavWrapperFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = (ViewGroup) inflater.inflate(R.layout.fragment_karaoke_nav_wrapper, container, false);
        presenter.onCreate();
        return view;
    }
