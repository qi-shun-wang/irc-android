...
*/
public class DeviceEntityDao extends AbstractDao<DeviceEntity, String> {
    ...
    @Override
    protected final String updateKeyAfterInsert(DeviceEntity entity, long rowId) {
        return entity.getAddress();
    }
    
    @Override
    public String getKey(DeviceEntity entity) {
        if(entity != null) {
            return entity.getAddress();
        } else {
            return null;
